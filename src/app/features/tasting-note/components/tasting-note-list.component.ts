...
export class TastingNoteListComponent extends BaseListComponent<TastingNoteResponse, TastingNoteRequest> {
  ...
  protected override onEditOpen(note: TastingNoteResponse): void {
    this.translationHelper.patchArray(this.translationsArray, note.translations, ['description']);
  }
  ...
  goToDetail(item: TastingNoteResponse): void {
    this.router.navigate(['/dashboard/tasting-notes', item.slug]);
  }
