...
export class HlmToggleGroup {
  ...
  constructor() {
    classes(
      () =>
        'rounded-md data-[size=sm]:rounded-[min(var(--radius-md),10px)] group/toggle-group flex w-fit flex-row items-center gap-[--spacing(var(--gap))] data-vertical:flex-col data-vertical:items-stretch',
    );
  }
}
